...
<%@include file="../../../../../core/interface/fragments/formHeadContent.jspf"%>
		...
		<link rel="stylesheet" href="<%= bundle.packagePath()%>assets/css/dmc.css" type="text/css" />
        <!-- Page Javascript -->
		...
		<script type="text/javascript" src="<%=bundle.packagePath()%>assets/js/dmc.js"></script>
